...
export type Product = {
  ...
  price?: number;
  gender?: "male" | "female" | "kids" | "both male & female";
  category?: Array<{
    _ref: string;
    _type: "reference";
    _weak?: boolean;
...
// Source: ./sanity/lib/products/getAllCategoriy.ts
...
export type ALL_PRODUCTS_QUERYResult = Array<{
  ...
  price?: number;
  gender?: "both male & female" | "female" | "kids" | "male";
  category?: Array<{
    _ref: string;
    _type: "reference";
    _weak?: boolean;
...
// Query: *[_type == "product"     && (title match $searchParam         || pt::text(description) match $searchParam)    ] | order(title asc)
...
// Source: ./sanity/lib/sales/getCouponCode.ts
// Variable: ACTIVE_SALE_BY_COUPON_QUERY
// Query: *[        _type == "sales"         && isActive == true         && couponCode == $coupponCode        ] | order(validUntil desc)[0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"product\" && slug.current == $slug] | order(title asc)[0]": PRODUCT_BY_SLUG_QUERYResult;
    "\n    *[_type == \"product\" \n    && (title match $searchParam \n        || pt::text(description) match $searchParam)\n    ] | order(title asc)": PRODUCT_SEARCH_QUERYResult;
